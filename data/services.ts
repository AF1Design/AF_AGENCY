...
export const servicesData: ServiceDefinition[] = [
  ...
  {
    id: "courses",
    title: "AI & Graphic Design Academy",
    shortDescription: "برامج تدريبية وتطبيقية مكثفة تؤهلك لإتقان أحدث أدوات الذكاء الاصطناعي وصناعة تصاميم استثنائية لكسب الدخل.",
    iconName: "GraduationCap",
    packages: [
      {
        id: "course-graphic-diploma",
        name: "Graphic Design Masterclass",
        description: "دبلومة الجرافيك ديزاين الشاملة من الصفر حتى الاحتراف وسوق العمل الحر الدولي والتعامل مع العملاء.",
        badge: "Comprehensive Program",
        recommended: true,
        features: [
          "احتراف برامج Adobe العالمية: Photoshop, Illustrator, InDesign",
          "قواعد التكوين البصري، سيكولوجية الألوان، وهندسة الخطوط (Typography)",
          "تصميم إعلانات السوشيال ميديا وتطبيقات الهويات البصرية للشركات",
          "بناء بورتفوليو احترافي حقيقي يجلب لك العملاء فور انتهاء التدريب",
          "أسرار التسعير، التفاوض، والتعاقد مع العملاء المحليين والدوليين"
        ]
      },
      {
        id: "course-ai-creator",
        name: "Generative AI Creative Course",
        description: "تعلم أسرار أدوات الذكاء الاصطناعي التوليدي لإنتاج تصاميم وصور وفيديوهات خيالية في دقائق معدودة.",
        badge: "Future Skill",
        features: [
          "هندسة الأوامر المتقدمة (Advanced Prompt Engineering) لتوليد صور بجودة سينمائية",
          "استخدام أحدث نماذج توليد وتعديل وتفريغ وتحسين جودة الصور",
          "صناعة فيديوهات ترويجية وإعلانية مبهرة بالذكاء الاصطناعي بدون كاميرا",
          "دمج مخرجات الذكاء الاصطناعي بسلاسة داخل برامج Adobe",
          "حقيبة أسرار حصرية تضم أكثر من 200 برومبت جاهز للاستخدام الفوري"
        ]
      },
      {
        id: "course-bundle",
        name: "Golden Dual Bundle (Design + AI)",
        description: "الباقة المزدوجة الشاملة: اجمع بين أساسيات الجرافيك ديزاين الراسخة وقوة الذكاء الاصطناعي بخصم خاص.",
        badge: "Maximum Value",
        features: [
          "الحصول على كامل محتوى ومحاور الدبلومتين معاً",
          "تطبيقات عملية مستمرة وتصحيح المشاريع خطوة بخطوة",
          "شهادة إتمام معتمدة رسمياً من AF AGENCY",
          "جلسة استشارية خاصة فردية (1-on-1) لمراجعة معرض أعمالك وخطة انطلاقتك"
        ]
      }
    ],
    addons: [
      {
        id: "addon-one-on-one",
        name: "Private 1-on-1 Mentorship Session",
        description: "جلسة فردية مباشرة مع المدرب لمراجعة بورتفوليو أعمالك وتقديم خطة نمو مخصصة.",
      },
      {
        id: "addon-lifetime-community",
        name: "AF VIP Creators Community Access",
        description: "انضمام حصري لمجتمع مصممي ومبدعي AF لمشاركة فرص العمل وتبادل الخبرات مدى الحياة.",
      }
    ]
  }
];
