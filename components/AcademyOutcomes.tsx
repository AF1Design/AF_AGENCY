...
export default function AcademyOutcomes() {
  const outcomes = [
    {
      icon: Award,
      title: "شهادة إتمام معتمدة برقم تسلسلي",
      description: "شهادة رسمية رقمية مطبوعة وموثقة برقم تحقق خاص يمكنك إضافتها لملف لينكد إن وسيرتك الذاتية لتعزيز ثقة أصحاب العمل.",
    },
    {
      icon: Download,
    ...
    {
      icon: ShieldCheck,
      title: "مراجعة واعتماد بورتفوليو التخرج",
